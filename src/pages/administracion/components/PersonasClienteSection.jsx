...
const PersonasClienteSection = ({ clienteSeleccionado }) => {
  ...
  const showSelectMessage = !clienteSeleccionado;
  const showSaveMessage = clienteSeleccionado && !clienteId;
  ...
  return (
    <section className="bg-white rounded-lg shadow p-6 space-y-4">
      ...
      {showSaveMessage && !showSelectMessage && (
        <p className="text-sm text-gray-500">
          Guarde primero el cliente para poder asociar personas.
        </p>
      )}
...
export default PersonasClienteSection;
