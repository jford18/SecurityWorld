...
CAMERAS AS (
    ...
    LEFT JOIN PUBLIC.HACIENDAS C ON (C.ID = B.HACIENDA_ID)
...
OFFLINE AS (
    ...
    LEFT JOIN PUBLIC.HACIENDAS D ON (D.ID = C.HACIENDA_ID)
...
FROM AGR A
LEFT JOIN PUBLIC.SITIOS B ON (B.NOMBRE = A.SITE_NAME)
LEFT JOIN PUBLIC.HACIENDAS D ON (D.ID = B.HACIENDA_ID)
